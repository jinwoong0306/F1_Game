...
> libGDX 기반 2D 탑다운 F1 레이싱 게임 with 전략적 타이어 관리 & 온라인 멀티플레이

[![Java](https://img.shields.io/badge/java-17%2B-orange.svg)](https://www.oracle.com/java/)
[![libGDX](https://img.shields.io/badge/libGDX-1.13.1-red.svg)](https://libgdx.com/)
[![License](https://img.shields.io/badge/license-MIT-blue.svg)](LICENSE)

**프로젝트 상태**: Phase 4 완료 | Phase 5 (폴리싱) 진행 중 | 최종 업데이트: 2025-12-04
...
- ✅ **멀티플레이**: 2-4인 온라인 대전 (구현 완료)
- ✅ **연습 모드**: 자유 주행 및 트랙 숙지

### 🔧 전략 시스템
| 타이어 | 성능 보너스 | 내구도 | 최적 상황 |
|--------|------------|--------|-----------|
| **Soft (빨강)** | 속도 +12% | 90초 | 짧은 스틴트 |
| **Medium (노랑)** | 기본 성능 | 130초 | 균형 전략 |
| **Hard (흰색)** | 회전력 -15% | 150초 | 긴 스틴트 |

- **타이어 마모**: 실시간 성능 저하
- **차량 내구도**: 충돌/오프로드 시 손상, 0 이하 시 속도 30% 제한
...
| 문서 | 설명 | 독자 |
|------|------|------|
| **[CLAUDE.md](CLAUDE.md)** | AI 어시스턴트 컨텍스트, 아키텍처 가이드 | AI/개발자 |
| **[PROGRESS.md](PROGRESS.md)** | 통합 진행 기록 및 변경 이력 | 모든 팀원 |
| **[PHASES.md](PHASES.md)** | Phase별 상세 체크리스트 | 개발자 |
...
### 최근 업데이트 (2025-12-04)
- ✅ 성능 최적화 (GC 부하 780개/초 → 0개/초)
- ✅ 멀티플레이 고스트 플레이어 버그 수정
- ✅ 미니맵 플레이어 색상 구분
- ✅ 타이어 컴파운드 밸런스 조정
- ✅ 브레이크 키 변경 (SPACE → SHIFT)
- ✅ singleplay-polish 브랜치 병합
...
### 🤝 기여 절차
1. **브랜치 확인**: [CLAUDE.md](CLAUDE.md) 참고
2. **Feature Branch** 생성 (`feature/multiplayer-core` 등)
3. **커밋 메시지 규칙**:
   ```
   Feat: 새로운 기능 추가
   Fix: 버그 수정
...
- 객체 재사용: 렌더 루프에서 `new Vector2()` 대신 임시 변수 사용
